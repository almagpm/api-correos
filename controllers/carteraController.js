...
const carteraCredito = async (req, res) => {
    try {
        ...
        const validacionCierre = `SELECT * FROM precierre WHERE fecha_cierre = current date`;
        ...
        if (!validacionResult || validacionResult.rowCount === 0) {
            ...
            const consulta = `SELECT * FROM spsgenerarchivocartera_node_(current date, 0, '02')`;
        ...
        const validacionCierreS = `SELECT * FROM precierre WHERE fecha_cierre = current date`;
        ...
        if (!validacionResultS || validacionResultS.rowCount === 0) {
            ...
            const consultaS = `SELECT * FROM spsgenerarchivocartera_node_(current date, 0, '01')`;
        ...
        const validacionCierreQ = `SELECT * FROM precierre WHERE fecha_cierre = current date`;
        ...
        if (!validacionResultQ || validacionResultQ.rowCount === 0) {
            ...
            const consultaQ = `SELECT * FROM spsgenerarchivocartera_node_(current date, 0, '03')`;
